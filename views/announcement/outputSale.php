    ...
    <div class="container">
        ...
        <div class=" photosPreview carousel carousel-slider">
            ...
            foreach ($photos as $photo) {
                ?>
                <a class="carousel-item"><img src="<?= "/uploads/image/sale/$photo[name_photo]" ?>"
        ...
        <div class="row s12" style="margin-top: 50px;">
            ...
            <div class="input-field col s4">
                <fieldset style="border-color: #EE6E73;">
                    ...
                    <h5 style="margin: 0;"><?= $announcement['rooms_count'] ?></h5>
                </fieldset>
            </div>
            ...
            <div class="input-field col s8">
                <fieldset style="border-color: #EE6E73;">
                    ...
                    <h5 style="margin: 0;"><?= $announcement['ownership'] ?></h5>
                </fieldset>
            </div>
        </div>
